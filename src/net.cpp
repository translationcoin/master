...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("TranslationCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("TranslationCoin-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("TranslationCoin-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TranslationCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("TranslationCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("TranslationCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("TranslationCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("TranslationCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TranslationCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("TranslationCoin-start");
