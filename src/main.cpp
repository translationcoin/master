...
unsigned int nStakeMinAge = 8 * 60 * 60; // 1 day
...
const string strMessageMagic = "TranslationCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TranslationCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "TranslationCoin launched 2014.10.11.";
        CTransaction txNew;
        txNew.nTime = 1413010581;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("9bc06a5afa2eb8fdcc079bfe88a99a4a959d95eb01e4a1da08df9ac42d2f37ed"));
        block.print();
